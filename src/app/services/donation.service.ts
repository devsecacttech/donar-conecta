    ...
    return [
      {
        ...
        impactStory: {
          ...
          managerId: '2',
          managerName: 'Carlos Ponce',
          beneficiaryMessage: '¡Muchas gracias! Los niños están muy contentos con sus nuevos cuadernos y lápices.',
          description: 'Se entregaron mochilas, cuadernos, lápices y material escolar a la familia Tamayo.',
          views: 45
        }
      },
      {
