...
export class BeneficiaryService {
  ...
  private getMockBeneficiaries(): Beneficiary[] {
    return [
      {
        id: 'b1',
        profileName: 'Niño Juan - Familia Tamayo',
        age: 10,
        familySize: 4,
        ...
        needs: ['Material escolar', 'Alimentación', 'Ropa'],
      ...
      },
      {
        ...
        needs: ['Alimentos básicos', 'Ropa', 'Ayuda para el alquiler'],
      ...
      {
        id: 'b3',
        profileName: 'Señora Ana - Familia Andrade',
        age: 65,
        familySize: 2,
        location: 'Cuenca, Ecuador',
        situation: 'Jubilada con pensión mínima. Vive con su nieta de 8 años tras el fallecimiento de su hija.',
